...
# 仅安装特定的技能（例如：头条新闻）
npx skills add <your-github-username>/<your-repo-name> --skill zaker-hotnews
npx skills add <your-github-username>/<your-repo-name> --skill zaker-categorynews
```
